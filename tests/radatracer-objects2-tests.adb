...
package body Radatracer.Objects2.Tests is
   ...
   function Default_World return World is
      ...
      World : Radatracer.Objects2.World := (
   ...
   procedure Test_Ray_Sphere_Intersections (T : in out AUnit.Test_Cases.Test_Case'Class) is
      ...
      use type Radatracer.Objects2.Intersection_Vectors.Vector;
   ...
   procedure Test_Lightning (T : in out AUnit.Test_Cases.Test_Case'Class) is
      ...
      Material : constant Radatracer.Objects2.Material := (others => <>);
   ...
   overriding function Name (T : Test) return AUnit.Message_String is
      pragma Unreferenced (T);
   begin
      return AUnit.Format ("Radatracer.Objects2");
   end Name;
end Radatracer.Objects2.Tests;
