...
procedure Scene is
   ...
   Floor : constant Radatracer.Objects.Object_Access := new Radatracer.Objects.Spheres.Sphere'(
   ...
   Left_Wall : constant Radatracer.Objects.Object_Access := new Radatracer.Objects.Spheres.Sphere'(
      Inverted_Transformation => Radatracer.Matrices.Invert (
   ...
   Right_Wall : constant Radatracer.Objects.Object_Access := new Radatracer.Objects.Spheres.Sphere'(
      Inverted_Transformation => Radatracer.Matrices.Invert (
         Radatracer.Matrices.Translation (0.0, 0.0, 5.0) *
         Radatracer.Matrices.Rotation_Y (-Ada.Numerics.Pi / 4.0) *
         Radatracer.Matrices.Rotation_X (Ada.Numerics.Pi / 2.0) *
